    ...
    lessons: [
      {
        id: 'u1-doremi',
        title: 'Do Re Mi',
        concept: 'Your first three notes',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 60,
        passAccuracy: 0.7,
        notes: [C4, D4, E4],
      ...
      },
      {
        id: 'u1-tune',
        title: 'A little tune',
        concept: 'Jumping between notes',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 80,
        passAccuracy: 0.75,
        notes: [C4, E4, G4, E4, C4, G4, C5],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        id: 'u2-fsharp',
        title: 'Meet Fa#',
        concept: 'Your first black key',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 70,
        passAccuracy: 0.7,
        notes: [E4, Fs4, G4, Fs4, E4],
      },
      {
        id: 'u2-bflat',
        title: 'Meet Sib',
        concept: 'Another black key',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 70,
        passAccuracy: 0.7,
        notes: [A4, Bb4, A4, G4, A4],
      },
      {
        id: 'u2-blacks',
        title: 'Black-key walk',
        concept: 'Several black keys',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 66,
        passAccuracy: 0.7,
        notes: [Fs4, Gs4, Bb4, Gs4, Fs4],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        concept: 'Do and Mi at the same time',
        kind: LessonKind.Chord,
        milestone: 1,
        bpm: 50,
        passAccuracy: 0.6,
        chords: repeat([C4, E4], 3),
      },
      {
        id: 'u3-triad-c',
        title: 'Your first chord',
        concept: 'The C major chord',
        kind: LessonKind.Chord,
        milestone: 1,
        bpm: 45,
        passAccuracy: 0.6,
        chords: repeat(chord(C4), 3),
      },
      {
        id: 'u3-triad-f',
        title: 'The F chord',
        concept: 'A new chord shape',
        kind: LessonKind.Chord,
        milestone: 1,
        bpm: 45,
        passAccuracy: 0.6,
        chords: repeat(chord(F4), 2),
      },
      {
        id: 'u3-triad-g',
        title: 'The G chord',
        ...
        bpm: 45,
        passAccuracy: 0.6,
        chords: repeat(chord(G4), 2),
      },
      {
        id: 'u3-changes',
        title: 'Change chords',
        concept: 'Move between chords',
        kind: LessonKind.Chord,
        milestone: 1,
        bpm: 40,
        passAccuracy: 0.6,
        chords: [chord(C4), chord(F4), chord(G4), chord(C4)],
      },
    ],
  },
  {
    ...
    lessons: [
      {
        id: 'u4-lh',
        title: 'The left hand',
        concept: 'Playing low notes',
        kind: LessonKind.TwoHands,
        milestone: 1,
        bpm: 70,
        passAccuracy: 0.65,
        right: [],
        left: [
          { midi: C3, startBeat: 0, dur: 1 },
          { midi: D3, startBeat: 1, dur: 1 },
          { midi: E3, startBeat: 2, dur: 1 },
          { midi: F3, startBeat: 3, dur: 1 },
      ...
      },
      {
        ...
        left: [
          { midi: C3, startBeat: 0, dur: 2 },
          { midi: F3, startBeat: 2, dur: 2 },
          { midi: G3, startBeat: 4, dur: 2 },
        ],
      },
      {
        id: 'u4-song',
        title: 'A two-hand song',
        concept: 'A whole song, both hands',
        kind: LessonKind.TwoHands,
        milestone: 1,
        bpm: 72,
        passAccuracy: 0.65,
        ...
        left: [
          { midi: C3, startBeat: 0, dur: 2 },
          { midi: F3, startBeat: 2, dur: 2 },
          { midi: F3, startBeat: 4, dur: 2 },
          { midi: C3, startBeat: 6, dur: 2 },
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        id: 'u5-gmajor',
        title: 'G major',
        concept: 'A scale with one sharp',
        kind: LessonKind.Melody,
        milestone: 1,
        bpm: 72,
        passAccuracy: 0.75,
